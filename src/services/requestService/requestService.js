...
const isUsingMockData = true; // TRUE for mock data and FALSE for API
...
//   const { isUsingMockData } = useData(); // Access isUsingMockData from the context
...
//   const { fetchData } = BaseDataService();

//   const getUserData = async (userId) => {
//     return await fetchData(`/user/${userId}`);
//   };

//   const getUserActivity = async (userId) => {
//     return await fetchData(`/user/${userId}/activity`);
//   };

//   const getUserAverageSessions = async (userId) => {
//     return await fetchData(`/user/${userId}/average-sessions`);
//   };

//   const getUserPerformance = async (userId) => {
//     return await fetchData(`/user/${userId}/performance`);
//   };

//   return { getUserData, getUserActivity, getUserAverageSessions, getUserPerformance };
// };
...
//   // Choose the appropriate data service based on isUsingMockData
//   const service = isUsingMockData ? MockDataService() : ApiDataService();
...
//   const getUserAverageSessions = async (userId) => {
//     return await service.getUserAverageSessions(userId);
//   };

//   const getUserPerformance = async (userId) => {
//     return await service.getUserPerformance(userId);
//   };
